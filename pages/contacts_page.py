...
class ContactsPage(BasePage):
    ...
    def find_button_contacts(self):
        return self.find_element(ContactsPageSelectors.button_selector)

    @property
    def find_logo_tensor(self):
        return self.find_element(ContactsPageSelectors.logo_tensor_selector)

    @property
    def click_logo_tensor(self):
        self.find_logo_tensor.click()
    ...
    def find_link_change_region_in_contacts_block(self):
        ...
        """
        return self.find_element_in_block(
            self.find_contacts_top_block, *ContactsPageSelectors.contacts_top_block_link_region_selector
        )
    ...
    def find_region_panel_list(self):
        ...
        """
        return self.find_element(ContactsPageSelectors.region_panel_list_selector)
    ...
    def wait_after_change_region(self):
        ...
        return wait.until(
            EC.text_to_be_present_in_element(ContactsPageSelectors.contacts_city_partners_selector,
...
class ContactsPageSelectors:
    ...
    tensor_block_4_selector = (
        By.CSS_SELECTOR,
        ".s-Grid-col.s-Grid-col--6.s-Grid-col--sm12",
    )
    tensor_block_4_selector_text = (
        By.CSS_SELECTOR,
        ".tensor_ru-Index__card-title.tensor_ru-pb-16",
    )
    contacts_top_block_selector = (
        By.CSS_SELECTOR,
        ".sbis_ru-container.sbisru-Contacts__relative",
    )
    contacts_top_block_link_region_selector = (
        By.CSS_SELECTOR,
        ".sbis_ru-Region-Chooser__text.sbis_ru-link",
    )
    contacts_city_partners_selector = (
        By.CSS_SELECTOR,
        ".sbisru-Contacts-List__city.sbisru-text--standart.sbisru-Contacts__text--500.sbisru-Contacts__text--md-xm.pl-24.pl-xm-0.pt-16.pt-xm-12.pb-4.pb-xm-8.ws-flexbox.ws-justify-content-between.ws-align-items-start",
    )
    ...
    contacts_top_block_link_region_click_wait = (
        By.CSS_SELECTOR,
        ".controls-Field.js-controls-Field.controls-InputBase__nativeField.controls-Search__nativeField_caretEmpty.controls-Search__nativeField_caretEmpty_theme_sbisru.controls-InputBase__nativeField_hideCustomPlaceholder",
    )
